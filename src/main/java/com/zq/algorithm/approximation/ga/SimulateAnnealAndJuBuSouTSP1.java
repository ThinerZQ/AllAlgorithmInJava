...
public class SimulateAnnealAndJuBuSouTSP1 {

	private int cityNum = 25; // 城市数量,编码长度
	private int MAX_GEN = 100000;
	...
	private double temperature = 100000;// 初始化温度
	private double coolingRate = 0.99999;// 冷却率
	private int bestT2;
	// 局部搜索
	...
	public SimulateAnnealAndJuBuSouTSP1() {
	...
	public static void main(String[] args) {
		...
		SimulateAnnealAndJuBuSouTSP1 tsp = new SimulateAnnealAndJuBuSouTSP1();
		// 初始化
		tsp.init();
		tsp.solve();
